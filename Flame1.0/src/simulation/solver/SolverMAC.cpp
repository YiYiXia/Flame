...
void SolverMAC::SolverInitial(IntegralType SType, vector<SDFInfo>* SDFlist)
{
	Type = SType;
	objList = SDFlist;
...
void SolverMAC::AddParticle(vector<Vector2d> *particleList, ParticleType particleType, Vector2d particleVelocity, Vector3d particleColor)
{
...
void SolverMAC::InformationReturn()
{
